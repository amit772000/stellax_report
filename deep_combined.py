...
def create_dynamic_price_chart(data_df, vacant_value_final_price_paid, price_column='Price_paid'):
    ...
    # Add value annotation for the peak
...
def draw_page5_table(c, start_x=70, start_y=468, row_height=1):
    """Draw table for page 5 with vacant values comps"""
...
def draw_page10_table(c, start_x=70, start_y=468, row_height=1):
    """Draw table for page 10 with market rent comps"""
...
def draw_page10(c, w, h):
    """Page 10: Market rent comps table"""
    c.setFont("Regular", 10)
    c.setFillColorRGB(130/255, 130/255, 130/255)
...
def draw_energy_label_page(c, w, h):
    """Page 16: Energy label impact table"""
...
def common_page_template(c, w, h):
    """Common template for pages 17, 18, 19"""
    # Footer
    c.setFont("Regular", 10)
    c.setFillColorRGB(130/255, 130/255, 130/255)
    draw_right_aligned(c, variables.address, 540, 23, "Regular", 10)
...
def draw_wws_points_page11(c, w, h):
...
if __name__ == "__main__":
    ...
    # Add overlays for all pages
    # Pages 0-5: Original report pages
    ...
    filler.add_overlay(6, common_page_template)
    filler.add_overlay(7, common_page_template)
    filler.add_overlay(8, common_page_template)
    

    # Pages 10-19: Additional report pages
    filler.add_overlay(9, draw_page10)
    filler.add_overlay(10, common_page_template)
    filler.add_overlay(11, draw_wws_points_page11)
    filler.add_overlay(12, common_page_template)
    filler.add_overlay(13, common_page_template)
    filler.add_overlay(14, common_page_template)
